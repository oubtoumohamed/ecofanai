    ...
    <div class="card-body">
        <ul class="nav nav-pills animation-nav nav-justified gap-2 mb-3" role="tablist">
            <li class="nav-item waves-effect waves-light">
                <a class="nav-link active" data-bs-toggle="tab" href="#animation-home" role="tab"><i class="ri-qr-scan-2-line fs-20 p-2 rounded-circle align-middle me-2"></i>Scan Qrcode</a>
            </li>
            <li class="nav-item waves-effect waves-light">
                <a class="nav-link" data-bs-toggle="tab" href="#animation-profile" role="tab"><i class="ri-vidicon-2-line fs-20 p-2 bg-primary-subtle rounded-circle align-middle me-2"></i> Take a video</a>
            </li>
        </ul>
