...
<body>
    <!-- auth-page wrapper -->
    <div class="auth-page-wrapper p-4 d-flex justify-content-center align-items-center min-vh-100" style="background-image: url('{{ asset('assets/images/bg.png') }}');    background-size: cover;">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5">
                        ...
                        <div class="card mt-4 bg-white">
                            ...
                            <div class="card-body">
                                <div class="text-center" style="background: #405189;">
                            		<img class="mt-4 mb-4" src="{{ asset('assets/images/logo-light.png') }}" style="height: 200px;">
